...
maskSHP = r"P:\SDB\Anegada\Final\anagada_mask.shp" # in_shp
...
boolean, green_SDB_output, ratioBlueArrayOutput, lnBlueArrayOutput, ratioImage = sdb.pSDBgreen (maskedBlue, maskedGreen, maskSHP, rol_name='Anegada_RoL')
